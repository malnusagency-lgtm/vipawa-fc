...
const SocialIcon = ({ href, label, bgColor, hoverBg, children }) => (
    <a
        href={href}
        target="_blank"
        rel="noopener noreferrer"
        aria-label={label}
        className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 group ${bgColor} ${hoverBg} hover:scale-110 hover:shadow-lg`}
    >
        {children}
    </a>
);
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-16">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3">
                            {/* Instagram - Gradient */}
                            <SocialIcon href="#" label="Instagram" bgColor="bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600" hoverBg="hover:shadow-pink-500/40">
                            ...
                            {/* X (Twitter) - Black */}
                            <SocialIcon href="#" label="X (Twitter)" bgColor="bg-white/10" hoverBg="hover:bg-black hover:shadow-white/10">
                            ...
                            {/* Facebook - Blue */}
                            <SocialIcon href="#" label="Facebook" bgColor="bg-[#1877F2]" hoverBg="hover:bg-[#166FE5] hover:shadow-blue-500/40">
                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* YouTube - Red */}
                            <SocialIcon href="#" label="YouTube" bgColor="bg-[#FF0000]" hoverBg="hover:bg-[#CC0000] hover:shadow-red-500/40">
                                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* TikTok - Dark */}
                            <SocialIcon href="#" label="TikTok" bgColor="bg-white/10" hoverBg="hover:bg-black hover:shadow-white/10">
                                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link href="/gallery" className="text-white/60 hover:text-accent-blue transition-colors text-sm">Gallery</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li><Link href="/support" className="text-white/60 hover:text-accent-blue transition-colors text-sm">Contact Us</Link></li>
