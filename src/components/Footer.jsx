...
const Footer = () => (
    <footer className="bg-black/95 text-white pt-20 sm:pt-24 pb-10 sm:pb-12 overflow-hidden relative noise" role="contentinfo">
        <div className="absolute inset-0 z-0 pointer-events-none">
            <div className="absolute top-0 right-0 w-80 h-80 bg-gold/[0.06] rounded-full blur-[120px]" />
            <div className="absolute bottom-0 left-0 w-80 h-80 bg-accent-blue/[0.04] rounded-full blur-[120px]" />
        </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-14">
                <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-3">
                        <SocialIcon href="#" label="Instagram" bgColor="bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600">
                        ...
                        <SocialIcon href="#" label="X (Twitter)" bgColor="bg-white/[0.08] hover:bg-white/[0.15]">
                        ...
                        <SocialIcon href="#" label="Facebook" bgColor="bg-[#1877F2] hover:bg-[#166FE5]">
                            <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /></svg>
                        </SocialIcon>
                        <SocialIcon href="#" label="YouTube" bgColor="bg-[#FF0000] hover:bg-[#CC0000]">
                        ...
                        <SocialIcon href="#" label="TikTok" bgColor="bg-white/[0.08] hover:bg-white/[0.15]">
                ...
                <div>
                    <h4 className="font-bold uppercase tracking-wider mb-5 text-fluid-sm">Explore</h4>
                    <ul className="space-y-3">
                        {[
                            { href: '/club', label: 'The Club' },
                            { href: '/matches', label: 'Matches & Results' },
                            { href: '/news', label: 'News & Media' },
                            { href: '/gallery', label: 'Gallery' },
                            { href: '/support', label: 'Membership' },
                        ].map((link) => (
                            <li key={link.href}><Link href={link.href} className="text-white/40 hover:text-gold transition-colors text-fluid-sm">{link.label}</Link></li>
                        ))}
                    </ul>
                </div>
