            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12 mb-14">
                <div className="space-y-5">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <SocialIcon href="https://www.facebook.com/share/187uDYWYYe/" label="Facebook" bgColor="bg-[#1877F2] hover:bg-[#166FE5]">
                        ...
                        <SocialIcon href="https://www.tiktok.com/@vipawacf?_r=1&_t=ZS-95qngzasbMy" label="TikTok" bgColor="bg-white/[0.08] hover:bg-white/[0.15]">
